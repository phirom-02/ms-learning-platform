...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UsernameEmailDuplicationException.class)
    public ResponseEntity<ErrorResponse> handleUsernameEmailDuplicationException(UsernameEmailDuplicationException e) {
        Map<String, Object> error = new HashMap<>();
        error.put("message", e.getMessage());
